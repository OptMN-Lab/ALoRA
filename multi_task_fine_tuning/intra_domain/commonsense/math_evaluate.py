...
def main(
    ...
    for idx, data in enumerate(dataset):
        ...
        flag = False
        if args.dataset.lower() in ['aqua', 'mathqa']:
...
def parse_args():
    ...
    parser.add_argument('--dataset', choices=['AddSub', 'MultiArith', 'SingleEq', 'gsm8k', 'AQuA', 'SVAMP', 'mawps', 'mathqa'],
                        required=True)
    parser.add_argument('--model', choices=['LLaMA-7B', 'BLOOM-7B', 'GPT-j-6B', 'LLaMA3'], required=True)
